...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
			...
			<div id="index" class="header_absolute ds cover-background ">
										...
										<div class="intro_layers_wrapper">
											<div class="intro_layers">
												...
												<div class="intro_layer" data-animation="fadeInUp">
													<a href="#price" class="btn btn-maincolor btn-slider btn-medium">Book a Lesson</a>
												</div>
...
<style>
			...
			<!-- Section Gallery -->
            <section id="gallery" class="ls s-pt-90 s-pb-80 s-pt-xl-160 s-pb-xl-150container-px-5">
				<div class="container-fluid">
					<div class="row">
						<div class="col-12">
					...
					<div class="row isotope-wrapper masonry-layout c-gutter-5 c-mb-5" style="position: relative; height: 1432.12px;">
						...
						<div class="col-xl-4 col-sm-6" style="position: absolute; left: 50%; top: 0px;">
							<div class="vertical-item item-gallery content-absolute ds">
								<div class="item-media">
						...
						<div class="col-xl-4 col-sm-6" style="position: absolute; left: 0%; top: 359.281px;">
							<div class="vertical-item item-gallery content-absolute ds">
								<div class="item-media">
						...
						<div class="col-xl-4 col-sm-6" style="position: absolute; left: 50%; top: 1072.84px;">
							<div class="vertical-item item-gallery content-absolute  ds">
								<div class="item-media">
									<img src="images/gallery/25.jpg" alt="img">
								</div>
								<div class="item-content dark-bg">
									<h5>
										<a href="gallery-single.html">Consetetur sadipscing elitr, sed diam nonumy</a>
            ...
            <section  id="contact" class="ls s-pb-90 s-pt-85 s-pb-xl-160 s-pt-xl-155">
				<div class="container">
					<div class="row">
                        <div class="col-12">
                        <p class="text-center color-darkgrey mb-1">
                        ...
                        @endif
								...
								<form class=" c-mb-20 c-gutter-20" method="post" action="{{ route('appointment') }}">
                                    @csrf
									...
									<div class="row">
										...
										<div class="col-sm-12 text-center mt-xl-30 mt-10">
											<div class="form-group">
												<button type="submit" class="btn btn-outline-darkgrey btn-medium">Send
												</button>
											</div>
										</div>
									</div>
						...
						<div class="col-xl-4 col-lg-3 text-center text-lg-left animate" data-animation="fadeInUp">
							<div class="widget widget_text">
								...
								<p class="social-icons">
									...
									<a href="https://instagram.com/aquavibes___?igshid=MmJiY2I4NDBkZg==" class="fa bg-icon rounded-icon fa-instagram" title="instagram"></a>
								</p>
							</div>
							<div class="divider-60 divider-lg-0"></div>
						</div>
